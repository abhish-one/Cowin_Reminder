...
pincode_url = "/api/v2/appointment/sessions/public/findByPin?pincode=249203&date=24-05-2021"
district_url = "/api/v2/appointment/sessions/public/findByDistrict?district_id=507&date=24-05-2021"
payload = ''
headers = {
...
while(True):
    ...
    for i in json_data:
        ...
        if(i['min_age_limit']==45 and i['available_capacity_dose1'] > 0):
